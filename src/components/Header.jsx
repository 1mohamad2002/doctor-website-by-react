        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center  gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <p>
                Simply browse through our extensive list of trusted doctors ,
                 <br className='hidden sm:block'/>schedule your Appointmenthassle-free
            </p>
            </div>
            <a  className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300 'href="#speciality">Book appointment   
